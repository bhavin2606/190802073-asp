...
<body>
    <div class="reg-w3">
        <div class="w3layouts-main">
            ...
            <asp:TextBox ID="TextBox3" runat="server" class="ggg" placeholder="PASSWORD" TextMode="Password"></asp:TextBox>
            ...
            <asp:TextBox ID="TextBox4" runat="server" class="ggg" placeholder="CONFIRM PASSWORD"
                TextMode="Password"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Enter Confirm Password"
                ControlToValidate="TextBox4" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
            <asp:CompareValidator ID="CompareValidator1" class="ggg" runat="server" ErrorMessage="Password and Confirm Password does not match."
                ControlToCompare="TextBox3" ControlToValidate="TextBox4" ForeColor="Red" Display="Dynamic"></asp:CompareValidator>
            <div class="clearfix">
            </div>
            <h4>
