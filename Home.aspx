            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <%--<img  src="<%# Eval("image", "~/uploads/{0}") %>" />--%>
                            <asp:Image alt="" ID="Image1" height="300" width="500" ImageUrl='<%# Eval("image", "~/uploads/{0}") %>' runat="server" />
                            <a href="#" class="prise"><%# Eval("price") %> $</a>
                        </div>
                        <div class="place_info">
                            <a href="DestinationDetail.aspx"><h3><%# Eval("title") %></h3></a>
                            <p><%# Eval("description") %></p>
                            <div class="rating_days d-flex justify-content-between">
                                
                                <div class="days">
                                    <i class="fa fa-clock-o"></i>
                                    <a href="#"><%# Eval("Day") %> Days</a>
                                </div>
                               
                                    <asp:Button ID="Button1" runat="server" Text="Book Now" class="genric-btn danger circle" />
                            </div>
                        </div>
                    </div>
                </div>
